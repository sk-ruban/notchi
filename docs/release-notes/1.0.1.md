...
The in-app updater in 1.0.0 has an issue that can prevent this first update from appearing correctly. After installing 1.0.1 manually once, future updates will work through the new automatic update system.
